        ...
        <div className="article__right">
          <div className="article__block">
            ...
            <div className="article__info">
              <p className="article__date">{formatDistance(new Date(data.created_on), Date.now(), { locale: ru })} назад</p>
              <p className="article__city">Санкт-Петербург</p>
              <a className="article__link" target="_blank" onClick={() => dispatch(setReviewsModal())}>
                23 отзыва
              </a>
            </div>
            ...
            <div className="article__author author">
              ...
              <div className="author__cont">
                ...
                <p className="author__about">Продает товары с {data.user.sells_from}</p>
              </div>
            </div>
          </div>
        </div>
